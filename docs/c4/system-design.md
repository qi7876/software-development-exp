...
本文档以 C1、C2、关键容器 C3 和部署图说明系统边界，并保留逻辑类图与关键顺序图。Rust workspace 已映射核心容器；逻辑类和操作仍是未来实现约束，IPC 技术尚未确定。

## C1 系统上下文

### 数据备份系统上下文图

![数据备份系统上下文图](generated/system-context.svg)
...
![数据备份系统容器图](generated/system-component-overview.svg)
...
![数据备份系统部署图](generated/system-deployment.svg)
